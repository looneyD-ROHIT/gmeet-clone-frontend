...
const NAV_ITEMS = [
    {
        ...
        children: [
            {
                label: 'Who are We ?',
                subLabel: 'Create Meetings Instantly on the go!!!',
                href: '#',
            },
            {
                label: 'News and Upcoming Features',
        ...
        children: [
            {
                ...
                subLabel: 'Get 24x7 Support throught our online channels',
                href: '#',
            },
            {
                label: 'Report',
                subLabel: 'Report bugs, account compromise or feature suggestions',
                href: '#',
            },
        ],
    },
